...
function promptMe(){
    ...
    console.log ("User wants to include lower charaters: " + useLowerCase );

    let useUpperCase = confirm("Do you want to include uppercase characters?");
    console.log ("User wants to include upper charaters: " + useUpperCase);

    let useNumeric = confirm("Do you want to include numeric characters?");
    console.log ("User wants to include numeric charaters: " + useNumeric);

    let useSpecial = confirm("Do you want to include special characters?");
    console.log ("User wants to include special charaters: " + useSpecial);
    ...
    while (useLowerCase == false && useUpperCase == false && useNumeric == false && useSpecial == false) {
        ...
        console.log ("User did not select any Character - Loop")
        ...
        console.log ("User wants password length to be: " + passwordLength);
    ...
    let passwordLength = parseInt(prompt("How many characters do you want the password to be? Choose between 8 and 128 characters!"));
